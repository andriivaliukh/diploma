...
\begin{longtable}{@{}l@{\hspace{1em}}p{\dimexpr\textwidth-3.5cm\relax}@{}}
  ...
  ChaCha20-Poly1305 & потоковий шифр з автентифікацією (ChaCha20 stream cipher with Poly1305 MAC) \\
  ...
  LDAP     & протокол доступу до каталогів (Lightweight Directory Access Protocol) \\
  ...
  RADIUS   & протокол віддаленої автентифікації (Remote Authentication Dial-In User Service) \\
