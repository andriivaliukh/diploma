...
\begin{frame}[c]
  ...
  \fitfig{fig-matrix4}
  \par\vspace{0.25em}
  {\footnotesize\color{clGrey}\centering
    Критерії: open-source, self-hosted, активні у 2025, явна WG-інтеграція.\
    \cmark{} --- бажана властивість.
    Показано 3 із N; повна матриця --- у роботі.\par}
\end{frame}
...
\begin{frame}[c]
  ...
  \begin{center}
    {\normalsize\bfseries\color{clAccent}
      Користувач у мережі, лише поки триває його 2FA-сесія.}
  \end{center}
  \vspace{0.2em}
  \fitfig{fig-idea}
\end{frame}
...
\begin{frame}[shrink=15]
  ...
  \begin{center}
    ...
    \par\vspace{0.20em}
    {\small\color{clGrey}
      WireGuard у ядрі Linux\;·\;порівняння з чистим WireGuard і OpenVPN}
  \end{center}
  \vspace{0.15em}
...
\begin{frame}
  ...
  \begin{tabularx}{\textwidth}{@{}Xrr@{}}
    ...
    чистий WireGuard (Docker veth) & 20{,}56\;\% & 0{,}023\;\% \\
    \bottomrule
  \end{tabularx}
  \par\vspace{0.4em}
  {\footnotesize\color{clGrey}
