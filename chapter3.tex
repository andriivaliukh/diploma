...
\caption{Відповідь реєстрації користувача (HTTP 201): totp\_secret та qr\_code}
\label{fig:func-02}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/func-03.png}
\caption{Підтвердження TOTP-реєстрації (HTTP 200): success=true}
\label{fig:func-03}
\end{figure}
