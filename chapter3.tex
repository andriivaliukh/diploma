...
\textbf{Сценарій} & \textbf{Медіана ± СКВ (мс)} & \textbf{p95 (мс)} & \textbf{Примітка} \\\hline
Без VPN (базовий)     & $24{,}00 \pm 0{,}04$ & $24{,}08$ & еталон \\\hline
...
\begin{tabularx}{\textwidth}{|l|X|X|X|}\hline
\textbf{Сценарій} & \textbf{p95 (мс)} & \textbf{\textit{Bufferbloat} (мс)} & \textbf{Примітка} \\\hline
Без VPN (базовий)     & $24{,}20$ & $+0{,}12$ & еталон \\\hline
WG plain (ядро)       & $26{,}60$ & $+2{,}40$ & заповнення черги \texttt{sk\_buff} \\\hline
Ця система (WG+2FA)   & $27{,}26$ & $+3{,}06$ & перехід через мережевий простір імен \\\hline
OpenVPN (AES-256-CBC) & $24{,}88$ & $+0{,}48$ & обмежена смуга \\\hline
\end{tabularx}\end{table}
