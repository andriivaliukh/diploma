...
У підрозділі~3.1 описується структура проєкту та інструменти розробки.
Підрозділи~3.2--3.5 присвячені реалізації автентифікації, TOTP, управлінню
WireGuard та VPN-сесіями відповідно. У підрозділі~3.6 розглядається CLI-клієнт,
у підрозділі~3.7~--- конфігурація розгортання. Підрозділ~3.8 описує стратегію
тестування та наводить результати. Підрозділ~3.9 присвячений функціональному
тестуванню розгорнутої системи. Підрозділ~3.10 містить висновки до розділу.
...
консольна утиліта. Конфігурація побудови та залежностей описана у файлі
\texttt{pyproject.toml} для опису залежностей та конфігурації побудови.
...
Розроблено 7~тестових сценаріїв, що охоплюють повний życiецикл системи:
...
\textbf{Очікуваний результат}: HTTP~200, тіло відповіді містить поля
\texttt{"status": "healthy"} та \texttt{"wireguard": "up"}.

% <TODO: вставити скріншот відповіді health-ендпоінту>
...
\textbf{Очікуваний результат}: перший запит повертає HTTP~201 з полями
\texttt{totp\_secret} та \texttt{qr\_code}; другий~--- HTTP~200 з
\texttt{"success": true}.

% <TODO: вставити скріншот відповіді реєстрації з totp_secret>
% <TODO: вставити скріншот підтвердження TOTP-реєстрації>
...
\textbf{Очікуваний результат}: перша відповідь містить токен з обмеженою
областю \texttt{totp\_verify}; друга~--- повний токен з
\texttt{expires\_in: 86400}.

% <TODO: вставити скріншот відповіді логіну з requires_totp: true>
% <TODO: вставити скріншот отримання access_token після TOTP-верифікації>
...
\textbf{Очікуваний результат}: HTTP~201 з полями \texttt{assigned\_ip}
та \texttt{server\_public\_key}; \texttt{wg show} відображає вузол
з активним рукостисканням.

% <TODO: вставити скріншот створення VPN-сесії з assigned_ip>
% <TODO: вставити скріншот wg show з активним тунелем та handshake>
...
\textbf{Очікуваний результат}: публічна IP-адреса змінюється на адресу
VPN-сервера при активному тунелі та повертається до оригінальної після
його вимкнення.

% <TODO: вставити скріншот curl ifconfig.me з увімкненим тунелем (IP сервера)>
% <TODO: вставити скріншот curl ifconfig.me після вимкнення тунелю (оригінальний IP)>
...
\textbf{Очікуваний результат}: список користувачів з полем \texttt{role};
список сесій; відповідь на DELETE містить \texttt{"status": "revoked"}.

% <TODO: вставити скріншот списку користувачів (адмін-панель)>
% <TODO: вставити скріншот примусового відкликання сесії>
...
% <TODO: вставити скріншот відмови доступу не-адміну (HTTP 403)>
% <TODO: вставити скріншот відмови запиту без токена (HTTP 401)>
